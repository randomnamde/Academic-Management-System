...
CREATE TABLE IF NOT EXISTS college (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY UNIQUE,
    college_code VARCHAR(32) PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_teacher_college_code ON teacher(college_code);
...
CREATE INDEX IF NOT EXISTS idx_class_college_code ON class(college_code);
CREATE INDEX IF NOT EXISTS idx_class_major_code ON class(major_code);
CREATE INDEX IF NOT EXISTS idx_major_college_code ON major(college_code);

CREATE INDEX IF NOT EXISTS idx_arrangement_teacher ON course_arrangement(teacher_no);
