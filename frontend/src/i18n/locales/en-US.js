export default {
  ...
  route: {
    ...
    examArrangement: 'Exam Arrangement',
    rewardPunishment: 'Rewards & Punishments',
    ...
    teacherWorkload: 'Workload Statistics',
    backup: 'Data Backup',
  ...
  system: {
    ...
    syslogCenter: {
      ...
      desc: 'View system access records, operation logs, and exception tracking.',
      tagAccess: 'Access Logs',
      tagOperation: 'Operation Records',
      enter: 'Open System Logs'
    },
    ...
    securityPanel: {
      ...
      resetTitle: 'Reset All Account Passwords',
      resetDesc: 'Reset every account in the system back to the unified initial password. This is a high-risk admin action.',
      resetChip: 'High-Risk Action',
      resetInitial: 'Initial password: 123456',
      resetAction: 'Reset All Passwords',
      resetConfirmTitle: 'Reset all account passwords?',
      resetConfirmMessage: 'After confirmation, every account password in the system will be reset to 123456. This action cannot be undone. Continue?',
      resetVerifyTitle: 'Verify Current Admin Password',
      resetVerifyMessage: 'Enter your current password before resetting all account passwords to the initial password.',
      verifyPasswordLabel: 'Current Admin Password',
      verifyPasswordPlaceholder: 'Enter your current password',
      verifyPasswordRequired: 'Please enter your current password first',
      resetSuccess: '{count} accounts have been reset to the initial password.',
  ...
  profile: {
    ...
    roleLensTitle: 'Role Focus',
    roleLensFocusTitle: 'What matters most',
    ...
    passwordRules: {
      length: '8+ characters',
      caseMix: 'Uppercase and lowercase',
    ...
    roleLens: {
      ...
      schoolAdmin: {
        title: 'School governance workspace',
        desc: 'Keep your account identity clear for cross-system governance, permissions, and school-wide collaboration.',
        highlight1: 'Your profile is the anchor identity for school-level governance and coordination.',
        highlight2: 'Keep contact details complete so approval notices and governance alerts reach you quickly.',
        highlight3: 'A clear avatar and real name improve recognition across permissions, audit, and system settings.'
      },
      collegeAdmin: {
        title: 'College operations workspace',
        desc: 'Your identity should clearly reflect college affiliation for roster coordination, approvals, and local administration.',
        highlight1: 'College information should stay accurate so organization-scoped operations remain clear.',
        highlight2: 'Use consistent contact details to improve communication in college-level coordination.',
        highlight3: 'A complete profile helps teachers and students identify the responsible administrator faster.'
      },
      teacher: {
        title: 'Teaching identity workspace',
        desc: 'This view emphasizes your teaching identity so students, classes, and collaborators can recognize you quickly.',
        highlight1: 'Teacher number and department are the key identity anchors for course and class collaboration.',
        highlight2: 'A recognizable avatar helps students identify the right teacher across learning scenarios.',
        highlight3: 'Reliable phone and email make leave, attendance, and teaching notices easier to receive.'
      },
      student: {
        title: 'Learning profile workspace',
        desc: 'This view emphasizes your study identity so class information and personal learning recognition stay clear.',
        highlight1: 'Student number and class are your core learning identity markers inside the system.',
        highlight2: 'Accurate contact details help you receive teaching, attendance, and approval notifications in time.',
        highlight3: 'A complete profile makes it easier for teachers and administrators to confirm your identity.'
      }
    }
  },
  student: {
    ...
    majorRequired: 'Please select major',
  ...
  teacher: {
    ...
    examCount: 'Exams',
    invigilateHours: 'Invigilate Hours',
    workloadScore: 'Workload Score'
  },
  major: {
    pageTitle: 'Major Management',
    addMajor: 'Add Major',
    keywordPlaceholder: 'Search by code, name, or abbreviation',
    majorCode: 'Major Code',
    majorName: 'Major Name',
    majorAbbreviation: 'Abbreviation',
    college: 'College',
    ...
    enable: 'Enable',
    disable: 'Disable',
    dialogAddTitle: 'Add Major',
    dialogEditTitle: 'Edit Major',
    autoGenerateHint: 'Auto-generated after creation',
    majorNameRequired: 'Please enter major name',
    collegeRequired: 'Please select college',
    createSuccess: 'Major created successfully',
    updateSuccess: 'Major updated successfully',
    statusUpdated: 'Major status updated'
  },
  class: {
    ...
    autoGenerateHint: 'Generated automatically after creation',
    grade: 'Grade',
    gradePlaceholder: 'Grade, e.g. 2023',
    college: 'College',
    teacherNo: 'Homeroom Teacher No.',
  ...
  college: {
    ...
    collegeNameEn: 'College English Name',
    majorCount: 'Majors',
    description: 'Description',
    status: 'Status',
    statusEnabled: 'Enabled',
    ...
    collegeNameEnRequired: 'Please enter college English name',
    updateSuccess: 'Updated successfully',
    createSuccess: 'Created successfully',
  ...
  attendance: {
    ...
    studentPlaceholder: 'Search by name or student ID',
    student: 'Student',
  ...
  courseArrangement: {
    ...
    selectClass: 'Please select class',
    collegeRequired: 'Please select college',
    courseCodeRequired: 'Please select course',
    teacherNoRequired: 'Please select teacher',
  ...
  dashboard: {
    ...
    descStudent: 'Focus on courses, scores, attendance, and leave progress so today鈥檚 priorities are easy to open.',
    descAdmin: 'Focus on teaching coordination, risk handling, and system setup to jump into the most-used entries.',
    descTeacher: 'Focus on teaching schedules, student follow-up, and classroom risks for today鈥檚 teaching tasks.',
    ...
    statAbnormalNote: 'Today鈥檚 abnormal attendance records',
  ...
  rbac: {
    ...
    users: {
      ...
      selectionSummaryTitle: '{count} accounts selected',
      selectionSummaryDesc: 'The current selection is kept across pages until you clear it or change filters.',
      selectionPreviewAction: 'Preview Selected',
      selectionDrawerTitle: 'Selected Accounts ({count})',
      selectionDrawerDesc: 'Review the accounts currently selected across pages and remove any item before batch initialization.',
      selectionDrawerEmpty: 'No accounts are currently selected.',
      selectionSearchPlaceholder: 'Search selected account, name, role, college, or class',
      selectionSearchEmpty: 'No selected accounts match the current search.',
      selectionGroupCount: '{count} accounts',
      selectionUnknownRole: 'Unknown Role',
      selectionRemoveAction: 'Remove',
      selectionMetaRole: 'Role: {role}',
      selectionMetaCollege: 'College: {college}',
      selectionMetaClass: 'Class: {className}',
      statusEnabled: 'Enabled',
      statusDisabled: 'Disabled',
      statusUpdated: 'Status updated',
      selectCurrentPage: 'Select Page',
      clearSelection: 'Clear Selection',
      resetPasswordAction: 'Init Password',
      resetPasswordConfirmTitle: 'Initialize this account password?',
      resetPasswordConfirmMessage: 'The password for account {account} will be reset to 123456. Continue?',
      resetPasswordVerifyTitle: 'Verify Current Admin Password',
      resetPasswordVerifyMessage: 'Enter your current password before initializing the password for account {account}.',
      resetPasswordSuccess: 'Account {account} password has been reset to 123456.',
      batchResetPasswordAction: 'Init Selected ({count})',
      batchResetNoSelection: 'Please select at least one account first.',
      batchResetPasswordConfirmTitle: 'Initialize selected account passwords?',
      batchResetPasswordConfirmMessage: '{count} selected accounts will be reset to 123456. Continue?',
      batchResetPasswordVerifyTitle: 'Verify Current Admin Password',
      batchResetPasswordVerifyMessage: 'Enter your current password before initializing passwords for {count} selected accounts.',
      batchResetPasswordSuccess: '{count} selected accounts have been reset to 123456.',
      verifyPasswordLabel: 'Current Admin Password',
      verifyPasswordPlaceholder: 'Enter your current password',
      verifyPasswordRequired: 'Please enter your current password first',
  ...
  evaluation: {
    ...
    comment: 'Comment',
    commentPlaceholder: 'Enter your evaluation comment',
    anonymous: 'Anonymous',
    realName: 'Real Name',
    status: 'Status',
    statusPending: 'Pending',
  ...
  exam: {
    pageTitle: 'Exam Arrangement',
    addExam: 'Add Exam',
    editExam: 'Edit Exam',
    examCode: 'Exam Code',
    examCodePlaceholder: 'Enter exam code',
    courseArrangement: 'Course Arrangement',
    selectCourse: 'Select course',
    course: 'Course',
    teacher: 'Teacher',
  ...
  backup: {
    ...
    endTime: 'End Time',
    restore: 'Restore',
    restoreConfirm: 'Confirm restore from this backup? This will overwrite existing data!',
    ...
    enabled: 'Enabled',
    deleteConfirm: 'Confirm delete this strategy?',
    success: 'Success'
  },
  mentalHealth: {
    ...
    crisisDate: 'Crisis Date',
    description: 'Description',
    interventionMeasures: 'Intervention',
    outcome: 'Outcome',
  ...
  employment: {
    ...
    addRecord: 'Add Employment',
    addAlumni: 'Add Alumni',
    searchPlaceholder: 'Search by student no. or name',
    studentNo: 'Student No.',
    studentName: 'Name',
    className: 'Class',
    companyName: 'Company',
    ...
    rateByYear: 'Employment by Year',
    distributionByIndustry: 'Industry Distribution',
    distributionByCompanyType: 'Company Type Distribution',
    employmentRate: 'Employment Rate Trend'
  },
  sysLog: {
    pageTitle: 'System Logs',
    userId: 'User ID',
    operation: 'Operation',
    operationPlaceholder: 'Operation, e.g. Student Management',
    method: 'Method',
    ip: 'IP Address',
