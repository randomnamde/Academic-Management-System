...
(1, 2, 'T2024001', '张老师', 'MALE', '13800000002', 'teacher001@school.com', 'PROFESSOR', '计算机学院', 1, '2015-09-01', 1),
(2, 3, 'T2024002', '李老师', 'FEMALE', '13800000003', 'teacher002@school.com', 'ASSOCIATE_PROFESSOR', '计算机学院', 1, '2018-09-01', 1);
...
(1, 4, '2023010001', '王同学', 'MALE', '13800000004', 'student001@school.com', 'CSXXSOFT20230001', '2023-09-01', 'ENROLLED'),
(2, 5, '2023010002', '李同学', 'FEMALE', '13800000005', 'student002@school.com', 'CSXXSOFT20230001', '2023-09-01', 'ENROLLED');
...
(1, '欢迎使用学生管理系统', '学生管理系统正式上线，欢迎使用。', 'NOTICE', 'ALL', 1, 1, 1, 1),
(2, '期末考试安排通知', '本学期期末考试将于 2024 年 1 月 15 日至 20 日进行，请各位同学做好准备。', 'IMPORTANT', 'ALL', 2, 1, 0, 1),
(3, '寒假放假通知', '学校将于 2024 年 1 月 22 日开始放寒假，请各位同学安排好行程。', 'NOTICE', 'ALL', 1, 1, 0, 1);

INSERT INTO attendance (id, student_id, course_arrangement_id, attendance_date, status, check_in_time, remark) VALUES
(1, 1, 1, '2024-01-08', 'PRESENT', '07:55:00', NULL),
(2, 1, 2, '2024-01-08', 'PRESENT', '07:58:00', NULL),
(3, 2, 1, '2024-01-08', 'PRESENT', '07:50:00', NULL),
(4, 2, 2, '2024-01-08', 'LATE', '08:15:00', '交通拥堵');
