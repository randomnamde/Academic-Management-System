...
(1, 'T00CS20240001', 'T00CS20240001', '寮犺€佸笀', 'MALE', '13800000002', 'teacher001@school.com', 'PROFESSOR', '璁＄畻鏈哄闄?, 1, '2015-09-01', 1),
(2, 'T00CS20240002', 'T00CS20240002', '鏉庤€佸笀', 'FEMALE', '13800000003', 'teacher002@school.com', 'ASSOCIATE_PROFESSOR', '璁＄畻鏈哄闄?, 1, '2018-09-01', 1);
...
(1, '2023SO0001', '2023SO0001', '鐜嬪悓瀛?, 'MALE', '13800000004', 'student001@school.com', 'CSXXSOFT20230001', '2023-09-01', 'ENROLLED'),
(2, '2023SO0002', '2023SO0002', '鏉庡悓瀛?, 'FEMALE', '13800000005', 'student002@school.com', 'CSXXSOFT20230001', '2023-09-01', 'ENROLLED');
...
INSERT INTO announcement (id, title, content, type, target_role, priority, author_id, is_top, status) VALUES
(1, '娆㈣繋浣跨敤瀛︾敓绠＄悊绯荤粺', '瀛︾敓绠＄悊绯荤粺姝ｅ紡涓婄嚎锛屾杩庝娇鐢ㄣ€?, 'NOTICE', 'ALL', 1, 'admin', 1, 1),
(2, '鏈熸湯鑰冭瘯瀹夋帓閫氱煡', '鏈鏈熸湡鏈€冭瘯灏嗕簬 2024 骞?1 鏈?15 鏃ヨ嚦 20 鏃ヨ繘琛岋紝璇峰悇浣嶅悓瀛﹀仛濂藉噯澶囥€?, 'IMPORTANT', 'ALL', 2, 'admin', 0, 1),
(3, '瀵掑亣鏀惧亣閫氱煡', '瀛︽牎灏嗕簬 2024 骞?1 鏈?22 鏃ュ紑濮嬫斁瀵掑亣锛岃鍚勪綅鍚屽瀹夋帓濂借绋嬨€?, 'NOTICE', 'ALL', 1, 'admin', 0, 1);

INSERT INTO attendance (id, student_id, course_arrangement_id, attendance_date, status, check_in_time, remark) VALUES
(1, '2023SO0001', 1, '2024-01-08', 'PRESENT', '07:55:00', NULL),
(2, '2023SO0001', 2, '2024-01-08', 'PRESENT', '07:58:00', NULL),
(3, '2023SO0002', 1, '2024-01-08', 'PRESENT', '07:50:00', NULL),
(4, '2023SO0002', 2, '2024-01-08', 'LATE', '08:15:00', '浜ら€氭嫢鍫?);

INSERT INTO sys_user_role (user_id, role_code) VALUES
('admin', 'SCHOOL_ADMIN'),
('T00CS20240001', 'COURSE_TEACHER'),
('T00CS20240001', 'HOMEROOM_TEACHER'),
('T00CS20240002', 'COURSE_TEACHER'),
('T00CS20240002', 'HOMEROOM_TEACHER'),
('2023SO0001', 'STUDENT'),
('2023SO0002', 'STUDENT'),
('college_admin_cs', 'COLLEGE_ADMIN');
...
(1, '2024-2025-1', '2024-09-01', '2025-01-20', 'ACTIVE', '榛樿婵€娲诲鏈?);
